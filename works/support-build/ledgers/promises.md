...
*Every setup awaiting payoff, recorded the moment it appears on the page. Review the open list during every chapter plan.*

| Promise | Planted (ch.) | Weight | Status | Paid (ch.) |
|---|---|---|---|---|
| "Cannot stumble" — definition has unexplored edges; escort-verb/range question explicitly tabled by Cass ("we don't know where its edges are yet... we'll find out in training") | 1 | major | open — live rung paid ch. 5: Escort preserves Pip's footing on a shaking brace but cannot help if the brace breaks | — |
