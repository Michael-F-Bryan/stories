...
Spelling and idiom: British/Australian English ("centre", "realised", "colour"). Metric units. Currency: **marks** (roughly dollar-scale: a coffee is 4–5 marks, league-minimum player stipend is 2,600/month).
...
The country is a mid-sized coastal republic — everyone just says **the Republic**. Cities that matter so far:
...
- **Gate sirens** are a weather-app category. Aperture detected → graded within 48 hours → assignment posted → term countdown public. Schools run Break drills the way they used to run fire drills.
- **Awakening** happens to roughly 1 in 800 people, almost always between 16 and 20. It correlates with cumulative proximity to live apertures, which means city kids awaken more, which means everyone has an uncle with a theory about that. Newly awakened must present for **assessment** within 30 days (it's a fine if you don't).
- Assessment day is a life event with the emotional register of a driving test crossed with a talent-show audition. Recruiters attend the municipal centres the way scouts attend school sports finals.
- The awakened are maybe 0.12% of the population; most never go pro. There's steady unglamorous work: aperture-watch shifts, essence hauling, Authority survey teams, private security theatre.
- **Essence** — the residue harvested from dead gaunts and Gate Cores — is the economic engine: it's a power-dense industrial feedstock, and the Authority runs a standard buyback. A team that clears Gates eats. A team that clears them fast and clean on camera eats well.
- Everyone watches the League. Fantasy leagues, clip channels, technique breakdown streamers, the lot. The fan forum that matters is **GateWatch**; being "GateWatch famous" is usually bad news.

## Tone anchors (for drafting)

- The world is functional, not dystopian: the buses run, the noodles are good, the bureaucracy is tired but real.
- Gates are normalised but never safe — the register for a live Gate is aviation, not amusement park.
- Halden's civic personality: underdog pride, dark humour about District Nine, suspicion of Corvel money.
