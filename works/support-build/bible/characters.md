...
- 39. Class: **Bulwark** (warden; tower-shield kit). Built like the door she plays. Grey streak she doesn't dye. Ex-**Vantage** — the number-two major — where she anchored the front line for nine years.
- Left Vantage in Year 15 after the **Aldercourt Gate** wipe. She was there. She has never once discussed it on record, and her League file carries a conduct notation nobody can get unsealed. Founded Grave Society the same year. (What actually happened is in `plan/` — on the page, only what chapters have published.)
- Runs the team on savings, stubbornness, and a fixed principle: nobody goes into a Gate unread. She reads skill text like a lawyer — the only person in Ren's life so far who took his panel seriously.
- Flaws: secretive past self-protection has calcified into secretive management; asks for trust she won't reciprocate; spends her own body too cheaply in fights.
- **Voice:** short declaratives. No filler, no hedges. Questions that are instructions ("Read me the second line."). Praise arrives as increased expectations.

## Theo Ganz — striker

- 24. Class: **Edgerunner** (blade striker; short-range acceleration kit). Compact, fast, vain about his boots. Top-fifty duel-sim ratings in the division — and a broadcast liability, because on camera he chokes. His Year 20 meltdown clip ("the Ganz Freeze", 41 seconds of a man not moving) is a GateWatch meme with remixes.
- Grew up league-obsessed in Halden's District Three; washed out of the Kestrel Nine feeder at 19 for "attitude", which for once means what it says.
- Flaws: performs confidence hardest when he has least; deflects with jokes until the joke is the problem; desperate to matter on camera, terrified of the camera.
- **Voice:** fast, nickname-happy (he assigns them without asking; they stick), swears fluently, goes quiet mid-sentence when the fear hits. The jokes stop when stakes arrive — and everyone notices *that* tell.
...
- **Bea Okafor** — 14. Ren's sister. Texts in fragments, all lowercase, devastatingly observant. Keeps a spreadsheet of the levy without being asked. The person Ren is actually doing this for, and the one who'd tell him that's a stupid way to put it.
- **Ada Okafor** — Ren's mother. Night-shift sorter, chronically tired, fierce in bureaucratic combat since the Break. Rule in her house: nobody signs anything the same day they're handed it.
- **Marc Osei** — Grave Society's former sixth (warden-adjacent scout). Took a two-way development contract with **Kestrel Nine** eleven days before registration deadline, which is why the team is desperate. Not a villain; an ambitious 26-year-old who took the better offer and knows exactly how the timing looked. Ongoing rival-shaped wound.
- **Dree Vann** — captain of **Kestrel Nine**, Division D's top seed and Vantage's feeder affiliate. Smooth, media-trained, collects promising players and discards the rest on schedule. To be developed on-page as the rivalry ignites.

## Voice-differentiation quick check (for the dialogue pass)

Cover the tags: Cass = shortest sentence in the room. Theo = nicknames and velocity. Juno = "okay so—" and over-explanation. Pip = a number where a feeling should be. Doc = one dry sentence, then knitting. Ren = the precise question nobody else asked.
